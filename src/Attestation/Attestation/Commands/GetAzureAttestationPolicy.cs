...
namespace Microsoft.Azure.Commands.Attestation
{
    ...
    public class GetAzureAttestationPolicy : AttestationDataServiceCmdletBase
    {
        ...
        [Parameter(Mandatory = true,
            ...
            HelpMessage =
                "Specifies a name of the tenant. This cmdlet gets the attestation policy for the tenant that this parameter specifies."
        )]
        ...
        {
            if (ShouldProcess(Name, "GetAttestationPolicy"))
            {
                String policy = AttestationDataClient.GetPolicy(Name, Tee);
