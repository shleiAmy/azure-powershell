...
{
    /// <summary>
    /// Remove AttestationPolicy.
    /// </summary>
    [Cmdlet("Remove", ResourceManager.Common.AzureRMConstants.AzureRMPrefix + "AttestationPolicy", SupportsShouldProcess = true)]
    [OutputType(typeof(bool))]
    public class RemoveAzureAttestationPolicy : AttestationDataServiceCmdletBase
    {
        ...
        [Parameter(Mandatory = true,
            ...
            HelpMessage =
                "Specifies a name of the tenant. This cmdlet removes the attestation policy for the tenant that this parameter specifies."
        )]
        ...
        {
            if (ShouldProcess(Name, "RemoveAttestationPolicy"))
            {
